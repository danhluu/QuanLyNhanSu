        ...
        <v-list shaped>
            ...
            <v-list-item-group >
                ...
                <v-list-item v-model="selectedItem" >
                    ...
                    <v-list-item-content>
                        <v-list-item-title  class="white--text">Gửi Đơn</v-list-item-title>
                    </v-list-item-content>
                </v-list-item>
...
// import NavBar from "../../components/Layout/NavBarNhanVien.vue"
  export default {
    ...
    methods:{
        ...
        async GuiDon(){
          const nv = await axios.get("https://localhost:5001/api/NhanViens/Get/"+this.user.username);
          this.Don.MaNV = nv.data.MaNV;
          await axios.post("https://localhost:5001/api/DonXins",this.Don);
